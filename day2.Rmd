...
detach(colony)
```
* Make sure you can source your commands (or the file 2.1\_colony\_1.R) from RStudio
...
* A function has a name, arguments, procedural steps, ana a return value
```{r}
sqXplusX <- function(x){
  x^2 +x
}
...
* An example solution `20_6PanelPlotscript.R1`

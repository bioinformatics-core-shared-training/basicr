...
probes   <- na.omit(geneAnnotation$probe[match(genelist, geneAnnotation$HUGO.gene.symbol)])
...
heatmap(as.matrix(normalizedValues[exprows,]), ColSideColors = sampcol, col=rbPal)
```

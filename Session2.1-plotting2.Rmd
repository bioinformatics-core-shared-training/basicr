...
- Can also add text at arbitrary positions
    + again, we need to take care as the axis limits are defined in the original plot
    
```{r}
plot(patients$Height, patients$Weight, pch=16)
text(160,95, labels = "X",col="red")
text(90,100, labels = "Y",col="blue")
```
...
plot(patients$Age, patients$Weight, pch=16,axes=FALSE)
axis(1)
axis(4, at = c(60,65,70,75),labels = c("60kg","65kg","70kg","75kg"))
box()

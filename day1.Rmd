...
- Calculate the *body mass index* for each patient. Order the patients according to their bmi
    + $bmi = weight/height^2$
- A person is classified as overweight if they have a bmi > 25. Which patients are overweight using this criteria?
...
- We can plot a simple chart of the % NB amplification
    ...
    + plotting will be covered in detail tomorrow

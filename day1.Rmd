...
- To create a R markdown file, Click on **File** →  **New File**  -> **R Markdown** in Rstudio
...
- See `solutions/solution-exercise1.Rmd ` for solution to Exercise 1
- All exercises will have a markdown template that you can edit
...
##Logical indexing answers: solutions/solution-exercise2.Rmd
...
##Solution: solutions/solution-exercise3.Rmd
...
- In the `data` folder you will find the file `ozone.csv`
...
## Suggestions: solutions/solution-exercise4.Rmd

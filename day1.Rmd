...
```
  ...
  + or in RStudio go to **Tools** → **Install Packages**... and type the
package name

- `DESeq` is a Bioconductor package (http://www.bioconductor.org)
...
The operators for 'comparison' and 'logical' always return logical values! (`TRUE`, `FALSE`)
...
# See that two samples are amplified
...
- It's often helpful to double check where the data has been saved. Use *get working directory* function:
